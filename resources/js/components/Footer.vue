    ...
    <div class="pt-16">
        <div class="w-full border-gray-300 border-t lg:w-11/12 md:w-11/12 lg:mx-auto md:mx-auto">
            <div class="container mx-auto py-4">
                <div class="xl:flex lg:flex md:flex text-center md:!text-left pt-6 justify">
                    <div class="w-11/12 xl:w-3/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0">
                        <div class="flex items-center md:justify-start justify-center mb-6 xl:mb-0 lg:mb-0">
                            <img src="/img/logo_uc.png" alt="Logo UC" class="w-10 mr-2">
                            <img src="/img/logo_su.png" alt="Logo SU" class="w-10 mr-0 xl:mr-3">
                            <p class="ml-3 font-bold text-xl hidden xl:block">Technopreneurship Workshop 2022</p>
                        </div>
                    </div>
                    <div class="w-11/12 xl:w-1/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0 pt-3 xl:flex xl:justify-end  sm:pl-0">
                        <ul>
                            <li class="text-gray-800 font-bold text-xl mb-6">Community</li>
                            <li class="text-base text-gray-600 hover:text-gray-700 mb-2">
                ...
                <div class="xl:flex flex-wrap justify-between xl:mt-14 mt-10 pb-6  sm:pl-0 text-center sm:!text-left">
                    <div class="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0">
                        <p class="text-gray-800">2022 SU IMT Universitas Ciputra. All Rights Reserved</p>
                    </div>
                    ...
                    <div class="w-11/12 xl:w-1/6 lg:w-1/6 sm:w-11/12 mx-auto lg:mx-0 xl:mx-0 mb-6 lg:mb-0 xl:mb-0 mt-8 lg:mt-8 xl:mt-0">
                        <div class="flex justify-center sm:justify-center xl:justify-end space-x-6 pr-2 xl:pr-0 lg:pr-0 md:pr-0 sm:pr-0">
                            <div>
