<template>
    ...
    <div>
        <div class="w-full relative px-2 xl:px-0">
            ...
            <div class="relative z-10 container mx-auto py-6 lg:px-20 md:px-6 px-4">
                ...
                <div v-for="(team, index) in teams" :key="team.id" class="my-2 text-xs flex flex-row w-full">
                    <div class="px-2 py-2 items-center bg-white rounded-2xl shadow-md w-full">
